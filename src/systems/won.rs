...
pub fn won_game_schedule() -> Schedule {
    Schedule::builder()
        .add_system(render_victory_screen_system())
...
#[system]
pub fn render_victory_screen(#[resource] map: &Map) {
    ...
    batch.print_color_centered(h/2-2,   "You Won !",                ColorPair::new(BLUE2, BLACK));
